...
public class AffichagePersonnes implements Vue {
    ...
    public static AffichagePersonnes creer(Stage stage){//constructeur de la vue
        URL location = AffichagePersonnes.class.getResource("affichagePersonnes.fxml");//Url va servir à fusionner les deux repertoire pour trouver la vue
        ...
        AffichagePersonnes vue = fxmlLoader.getController();//chargement de la classe qui controlle la vue pas du controller dans le package controller qui va servir de chef d'orchestre
